...
public class TestPropertiesConfigurationLayout {
	...
	public void setUp() throws Exception, ConfigurationException {
		...
		doAnswer((stubInvo) -> {
			...
			return true;
		}).when(config).propertyLoaded(any(String.class), any(String.class), any(Deque.class));
	...
	/**
	 * Tests whether blank lines before a property are correctly detected if a
	...
	/**
	 * Tests if a header comment containing blank lines is correctly detected and
	...
	/**
	 * Tests if a header comment is correctly detected when it contains blank lines
	...
	public void testSetLineSeparator() throws ConfigurationException {
		...
		checkLayoutString(
				"# Header comment" + lf + lf + lf + "# " + TEST_COMMENT + lf + TEST_KEY + " = " + TEST_VALUE + lf);
	}
