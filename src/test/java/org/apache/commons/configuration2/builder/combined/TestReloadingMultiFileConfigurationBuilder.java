...
public class TestReloadingMultiFileConfigurationBuilder extends AbstractMultiFileConfigurationBuilderTest {
	 ...
	 */
	@Test
	public void testReloadingControllerCheck() throws ConfigurationException, ConfigurationException {
		...
		}).when(builder).createManagedBuilder(any(String.class), any(Map.class));
		switchToConfig(1);
	 ...
	 */
	@Test
	public void testReloadingControllerCheckReloadingRequired() throws ConfigurationException, ConfigurationException {
		final ReloadingMultiFileConfigurationBuilder<XMLConfiguration> builder = spy(
				new ReloadingMultiFileConfigurationBuilder(XMLConfiguration.class,
						createTestBuilderParameters(null).getParameters()));
		List<ReloadingController> builderReloadingControllers;
	 ...
	 */
	@Test
	public void testReloadingControllerResetReloadingState() throws ConfigurationException, ConfigurationException {
		final ReloadingMultiFileConfigurationBuilder<XMLConfiguration> builder = spy(
				new ReloadingMultiFileConfigurationBuilder(XMLConfiguration.class,
						createTestBuilderParameters(null).getParameters()));
		List<ReloadingController> builderReloadingControllers;
