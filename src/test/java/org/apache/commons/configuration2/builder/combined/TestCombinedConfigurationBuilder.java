...
public class TestCombinedConfigurationBuilder {
	...
	public void testCustomBuilderProvider() throws ConfigurationException {
		...
		builder.configure(new CombinedBuilderParametersImpl()
				.setDefinitionBuilder(createDefinitionBuilder(createDefinitionConfig(tagName, attrs)))
	...
	public void testBasePathForChildConfigurations() throws ConfigurationException {
		...
		builder.configure(new CombinedBuilderParametersImpl().setBasePath(deepDir.getAbsolutePath())
				.setDefinitionBuilder(new ConstantConfigurationBuilder(defConfig)));
	...
	public void testConfigurationBuilderProvider() throws ConfigurationException {
		...
		builder.configure(
				new CombinedBuilderParametersImpl().setDefinitionBuilder(new ConstantConfigurationBuilder(defConfig)));
		final CombinedConfiguration cc = builder.getConfiguration();
		assertEquals("Wrong number of configurations", 1, cc.getNumberOfConfigurations());
		checkProperties(cc);
	}
